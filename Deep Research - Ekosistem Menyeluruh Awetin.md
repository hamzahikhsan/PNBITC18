# Deep Research: Ekosistem Menyeluruh Awetin
...
**Konteks:** Konsolidasi seluruh riset sesi ini (lingkungan, masyarakat, kompetitor, model bisnis, regulasi, teknologi, UX) menjadi satu dokumen referensi tunggal — dasar penyusunan PRD lengkap Awetin

---

## Catatan Revisi 2 — Koreksi Kejujuran Riset (Pasca-Audit)

Saya sebelumnya menulis "jangan sisakan 1 aspek pun" sudah tercapai — itu terlalu percaya diri. Audit mandiri menemukan beberapa hal yang perlu dikoreksi:

1. **Nama produk sebelumnya ("TukangIn") ternyata sudah dipakai** aplikasi dan skripsi lain di domain persis sama (jasa tukang online) — lihat Bagian 15 (baru). Nama di dokumen ini sudah diganti "Awetin" sebagai usulan kerja, tapi tim tetap wajib verifikasi mandiri.
2. **Status hukum "mitra" gig economy (Bagian 9) hanya bersumber dari satu artikel opini** (The Conversation) — belum disilang-cek ke sumber hukum primer atau kedua. Kesimpulannya kemungkinan besar tetap benar (ini isu yang cukup dikenal luas), tapi secara metodologi seharusnya tidak berhenti di satu sumber.
3. **Angka e-waste "1,9 juta ton (2022)" dan "2 juta ton (2021, KLHK)" di Bagian 2 adalah dua sumber-tahun berbeda**, bukan angka yang sama — sebelumnya saya perlakukan seolah bisa dipakai bergantian, padahal seharusnya disebutkan sebagai estimasi yang bervariasi antar sumber, bukan angka tunggal yang pasti.
4. **Kerangka AI damage-assessment (Bagian 10) diadaptasi dari industri asuransi kendaraan/properti**, bukan dari preseden yang spesifik untuk barang kecil sehari-hari (sepatu, pakaian) — ini ekstrapolasi yang masuk akal, tapi bukan bukti langsung bahwa polanya identik untuk kategori barang Awetin.
5. **Data lokasi (GPS) belum disebutkan sebagai data pribadi yang dilindungi UU PDP** di Bagian 7.2 versi pertama — padahal sama seperti KTP, lokasi pengguna & tukang juga termasuk kategori ini. Sudah ditambahkan sebagai catatan di PRD revisi.
6. **Daftar sub-tema resmi turunan PNBITC masih belum dikonfirmasi ke panitia** — ini sudah disebut di dokumen brief paling awal sesi ini, tapi "terkubur" di dokumen-dokumen berikutnya. Ini technically item paling penting yang belum tuntas, karena berpotensi memengaruhi validitas seluruh kerangka konsep kalau sub-tema resmi ternyata berbeda dari yang diasumsikan tim.

Kesimpulan jujur: riset ini **cukup mendalam untuk dasar keputusan desain**, tapi tidak literal "sudah semua tanpa celah" — masih ada beberapa titik yang butuh verifikasi tambahan dari tim (terutama poin 1 dan 6 di atas) sebelum konsep benar-benar dikunci.

---

## Ringkasan Eksekutif

Dokumen ini menggabungkan seluruh riset yang sudah dilakukan sepanjang proses (mulai dari breakdown juklak, riset ideation awal, hingga pendalaman Awetin) ditambah lima area baru yang sebelumnya belum tersentuh: teknologi AI untuk deteksi kerusakan barang, regulasi platform digital Indonesia (PSE & UU PDP), standar pembayaran digital (QRIS), status hukum mitra/tukang sebagai pekerja gig economy, dan konvensi UX aplikasi super-app Indonesia. Tujuannya satu: memastikan tidak ada aspek dari lingkup tema "Tech for Nature by Crafting Sustainable Digital Solutions" — baik dari sisi lingkungan, sosial, bisnis, teknologi, maupun regulasi — yang luput sebelum tim menyusun blueprint produk (PRD) final.

Temuan paling penting dari babak riset baru ini: Awetin punya kewajiban kepatuhan yang lebih luas dari sekadar "desain bagus" — status tukang sebagai "mitra" (bukan karyawan) punya kekosongan hukum nyata di Indonesia yang perlu disikapi jujur dalam narasi produk; data KTP yang dikumpulkan untuk verifikasi tukang termasuk data pribadi yang dilindungi UU PDP dengan sanksi pidana kalau disalahgunakan; dan platform digital pada umumnya wajib terdaftar PSE di Kominfo. Ini semua bukan detail teknis yang bisa diabaikan karena "cuma prototype lomba" — justru sebaliknya, kemampuan tim menunjukkan kesadaran atas kewajiban-kewajiban ini adalah bukti nyata "kedalaman logika" yang dicari tema besar kompetisi ("Beyond the Prompt: Build the Logic, Own the Fundamental").
...
French Repairability Index (skor 0–10 kelayakan reparasi produk elektronik, wajib sejak 2021) dan gerakan Repair Café global (60.000 event/tahun, 1,5 juta pengunjung) jadi referensi desain, dengan catatan model bisnisnya berbeda dari Awetin (regulasi produsen vs. komunitas relawan vs. marketplace Awetin). Kompetitor lokal (Sejasa, Kanggo, lakuKan) dikonfirmasi bermain di jasa rumah tangga umum/konstruksi dengan mitra formal skala menengah — tidak ada yang menjadikan "reparasi anti-sampah" sebagai identitas inti atau menyasar tukang informal super-lokal. *(Detail lengkap di "Riset Kompetitor Awetin dan Pembedahan Poin 6.md".)*

---

## Bagian 5 — Model Bisnis: Harga & Bootstrap (Ringkasan)

TaskRabbit memakai tiga model harga (self-set hourly, task-based fixed, pre-set hourly) tergantung kategori; Sejasa memakai daftar harga referensi dengan disclaimer kondisi lapangan. Rekomendasi Awetin: "Estimasi Berjenjang dengan Persetujuan Wajib" — platform beri jangkar harga, tukang beri penawaran dengan alasan wajib kalau menyimpang, pengguna approve sebelum kerja dimulai. Strategi bootstrap dua sisi: fokus geografis sempit, onboarding manual awal, insentif mitra pertama, kemitraan dengan struktur yang sudah ada. *(Detail lengkap di "Pendalaman Awetin..." dan "Riset Kompetitor...".)*

---

## Bagian 6 — Regulasi Barang Bekas & E-Waste (Ringkasan)

Larangan "thrifting" di Indonesia hanya berlaku untuk pakaian bekas **impor**, bukan jual-beli/donasi barang bekas domestik (yang sepenuhnya legal). Elektronik rusak masuk kategori limbah B3 (PP 101/2014) dan wajib disalurkan lewat jalur resmi (dropbox e-waste), bukan dibuang sembarangan atau didonasikan begitu saja. Ekosistem donasi/daur ulang sudah ada tapi terfragmentasi per kategori (Waste4Change, Komunitas Saya Pilih Bumi, Ewasterj, dll) — Awetin diposisikan sebagai hub triase yang mengarahkan, bukan membangun ulang infrastruktur ini. *(Detail lengkap di "Pendalaman Awetin...", Bagian 2.)*
...
## Bagian 14 — BARU: Temuan Audit — Konflik Nama Produk

Saat mengaudit ulang dokumen-dokumen sesi ini, pencarian cepat menemukan nama "TukangIn" (nama kerja yang dipakai tim sebelumnya) **sudah dipakai** di beberapa tempat pada domain yang persis sama (platform/sistem jasa tukang online): skripsi/prototype "TukangIn.Aja — Platform Layanan Jasa Tukang" (Telkom University), aplikasi "TukanginAja" yang terdaftar di Google Play, situs "tukangindong.com" dengan tagline serupa ("solusi praktis perbaikan rumah"), dan jurnal ilmiah "Perancangan Sistem Informasi Jasa Tukang Online (TukangIn)".

**Implikasi:** juklak PNBITC#18 eksplisit mewajibkan "orisinalitas mutlak — karya harus 100% asli, belum pernah dipublikasikan/diikutkan lomba lain". Nama yang sama persis di domain konsep yang sama meningkatkan risiko dipertanyakan soal orisinalitas, meski secara teknis "nama mirip" berbeda dari "karya yang sama". Nama kerja di seluruh dokumen sesi ini sudah diganti menjadi **"Awetin"** sebagai usulan sementara — dipilih dari kata dasar "awet" (tahan lama/tidak mudah rusak), belum ditemukan konflik nama serupa saat pengecekan cepat, tapi **tim tetap wajib verifikasi mandiri lebih menyeluruh** (Google Play, App Store, PDKI/merek terdaftar) sebelum nama ini dipakai final di proposal — pengecekan saya bersifat cepat via pencarian web, bukan penelusuran merek dagang resmi.

**Sumber temuan konflik nama:**
- [Repositori — Perancangan Prototype Aplikasi TukangIn.Aja: Platform Layanan Jasa Tukang — Telkom University](https://repositori.telkomuniversity.ac.id/home/catalog/id/237567/slug/perancangan-prototype-aplikasi-tukangin-aja-platform-layanan-jasa-tukang-dalam-bentuk-buku-karya-ilmiah.html)
- [TukanginAja — Aplikasi di Google Play](https://play.google.com/store/apps/details?id=com.qqltech.tukang_segala_end_user&hl=en_US)
- [Tukangin — tukangindong.com](https://www.tukangindong.com/)
- [Perancangan Sistem Informasi Jasa Tukang Online (TukangIn) — Jurnal Khatulistiwa Informatika](https://jurnal.bsi.ac.id/index.php/khatulistiwa/article/view/11245)

---

## Bagian 15 — Sumber Baru (Selain yang Sudah Tercantum di Dokumen Sebelumnya)
